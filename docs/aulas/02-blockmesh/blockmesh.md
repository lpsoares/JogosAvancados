...
Perceba que um dos parâmetros na aba de detalhes é o Brush Type, que por padrão é aditivo, mas podemos altera-lo para subtrativo, para fazer um rasgo em outro brush: 
